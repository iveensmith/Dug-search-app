 ...
 *  to use, and won't fabricate any). The two circles roll into place on
 *  load: the cross badge from the left, the pill dish from the right (see
 *  hero-roll-* in globals.css; both respect prefers-reduced-motion). */
export default function HeroGraphic() {
  return (
    <svg viewBox="0 0 400 400" className="mx-auto w-full max-w-sm" role="img" aria-label="MediQuest illustration">
      <g className="hero-roll-left">
