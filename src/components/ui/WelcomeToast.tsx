...
export default function WelcomeToast() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-3 z-[2000] flex justify-center px-4 sm:top-4">
      <div className="animate-toast-in rounded-full bg-emerald-700 px-4 py-2 text-sm font-semibold text-white shadow-lg dark:bg-emerald-500 dark:text-emerald-950">
        Welcome back, {name}!
      </div>
    </div>
  )
